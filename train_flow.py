    ...
    while True:
        for inputs in dataloader:
            ...
            if data.seq_num >= len(data.files):
                ...
                mlflow.log_metric("synops loss", calculate_synops(model), step=data.epoch)
            ...
            if loss_function.num_passes >= config["data"]["passes_loss"]:
                ...
                bw_loss += loss + calculate_synops(model) * 1e-5
                
                assert train_loss/(data.samples + 1) < 10.0, 'Loss is exploding!'
